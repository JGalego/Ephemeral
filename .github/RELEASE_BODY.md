> **This is a pre-release.** Ephemeral has finished three of its seven phases,
> nothing here is signed by a known identity, and the Android application has
> never been run on a physical device. [The roadmap](https://github.com/JGalego/Ephemeral/blob/main/docs/roadmap.md)
